...
class offer_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventoffer_deleted', 'block_selfenrollment');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' deleted the offer with id '$this->objectid'.";
    }
